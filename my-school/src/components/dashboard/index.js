...
import { getFamily } from "../../redux/actions/user-actions";
...
const AdminDash = ({ user, isLoading, family, familyName }) => {
  ...
  return (
    <>
      <Heading>
        {user.familyName && capitalizeName(user.familyName)} Family
      </Heading>
      ...
      <div className="student-list">
        ...
        <Box as={Button} onClick={addStudent}>
          {" "}
          + Add new student
        </Box>
      </div>
