...
// import { useToast, Flex, Text, Divider, Input, Icon } from "@chakra-ui/core";
...
//             <Image thumbnail={Thumbnail} renderedUser={renderedUser} />
//             <Input
//               hidden
//               name="profilepic"
//               id="profilepic"
...
//             {user.username === "" && (
//               <Warning message="Must provide a username" />
//             )}
//             {user.user_type_id === 1 &&
//               EmailValidator.validate(user.username) === false && (
//                 <Warning message="Must provide a valid email" />
//               )}
//             <Password />
//             {passwordField === true ? (
...
//             passwordField === true &&
//             user.password !== "" ? (
//               <Text color="green.400" paddingLeft="22vw">
//                 <Icon name="check-circle" size="24px" /> Both password match
//               </Text>
//             ) : null}
//             {(passwordField === true &&
//               user.password !== user.passwordConfirm) ||
//             (passwordField === true && user.passord === "") ? (
//               <Text color="red.500" paddingLeft="12.5vw">
//                 <Icon name="warning" size="24px" color="red.500" /> Both
...
//                 <Icon name="warning" size="24px" color="red.500" /> Must provide
//                 a name
//               </Text>
//             ) : null}
//             {/* <SettingsButton
...
import { editProfileWithoutImage, deleteAccount, deleteEntireFamily, editProfileWithImage } from '../../redux/actions/user-actions';


const Settings = ({ family, editProfileWithoutImage, deleteAccount, deleteEntireFamily, editProfileWithImage }) => {
                ...
                <Flex direction='column'>
                    <form onSubmit={handleSubmit(handleUpdate)}>
                        ...
                        <Flex paddingLeft='7rem' className='settings-box' justifyContent='space-around' w='30vw'>
                            ...
                            <DeleteUser id={id} user={user} deleteAccount={deleteAccount} deleteEntireFamily={deleteEntireFamily} />
                        </Flex>
                    </form>
                </Flex>
            )}
...
export default connect(mapStateToProps, { editProfileWithoutImage, deleteAccount, deleteEntireFamily, editProfileWithImage })(Settings);